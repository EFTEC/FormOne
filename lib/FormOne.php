...
class FormOne
{
    ...
    private function renderCheckbox() {
        ...
        $html
            = "<input type='checkbox' {$this->renderId()} {$this->renderClasses()} {$this->renderExtra()} {$this->renderItemValue()} $checked />\n{$this->label}";
        return $html;
    }
    ...
    private function renderRadio() {
        ...
        $checked = ($this->value == $this->itemValue) ? 'checked' : '';
        $html
            = "<input type='radio' {$this->renderId()} {$this->renderClasses()} {$this->renderExtra()} {$this->renderItemValue()} $checked />\n{$this->label}";
        return $html;
    }
